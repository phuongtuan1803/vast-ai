...
hf download stabilityai/stable-diffusion-xl-base-1.0 sd_xl_base_1.0.safetensors --local-dir $CKPT_DIR --local-dir-use-symlinks False
...
hf download kijai/flux-fp8 flux1-dev-fp8.safetensors --local-dir $CKPT_DIR --local-dir-use-symlinks False

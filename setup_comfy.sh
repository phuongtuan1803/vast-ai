...
hf download stabilityai/stable-diffusion-xl-base-1.0 sd_xl_base_1.0.safetensors --local-dir $CKPT_DIR
...
hf download kijai/flux-fp8 flux1-dev-fp8.safetensors --local-dir $CKPT_DIR
...
hf download kijai/flux-fp8 flux-vae-bf16.safetensors --local-dir $VAE_DIR
mv $VAE_DIR/flux-vae-bf16.safetensors $VAE_DIR/ae.safetensors
